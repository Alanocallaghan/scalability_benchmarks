...
qsub -t 1-$(cat data/downsampling_ref_grid.txt | wc -l) -tc 5 scripts/chain-scripts/removing_cells_ref.sh
qsub -t 1-$(cat data/downsampling_grid.txt | wc -l) -tc 5 scripts/chain-scripts/removing_cells.sh
